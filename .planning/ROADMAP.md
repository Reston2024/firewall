...
- [x] 05-02-PLAN.md — Telemetry deployment runbook + human checkpoint: deploy stack, configure IPFire syslog, verify syslog path live
...
| 5. Telemetry Pipeline and Dashboards | 2/4 | In Progress|  |
